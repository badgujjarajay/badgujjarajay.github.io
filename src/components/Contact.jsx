  ...
  return (
    <section id="contact" className="py-20 bg-gray-50 dark:bg-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">{contact.title}</h2>
          <h3 className="text-xl text-blue-600 dark:text-blue-400 mb-6">{contact.subtitle}</h3>
